...
public class CommitTest {
  ...
  public void commitTest() {
    LOGGER.info("Create and delete commit test start................................");
    ...
    try {
      /*SetCommit setCommit =
          SetCommit.newBuilder()
              .setId(
                  CommitIdentification.newBuilder()
                      .setNamedId(CommitNamedIdentification.newBuilder().setName("name").build())
                      .build())
              .setCommit(Commit.newBuilder().setName("name"))
              .build();
      Response result = versioningServiceBlockingStub.createCommit(setCommit);
      long id = result.getCommit().getId();*/

      LOGGER.info("Create and delete commit test end................................");
    } finally {

...
public class ExperimentTest {
  ...
  @Test
  public void findExperimentsTest() {
    LOGGER.info("FindExperiments test start................................");
    ...
    createExperimentRequest = getCreateExperimentRequest(project.getId(), "Experiment_2");
    attribute1 =
        KeyValue.newBuilder()
            .setKey("attribute_1")
    ...
    createExperimentRequest = getCreateExperimentRequest(project.getId(), "Experiment_3");
    attribute1 =
        KeyValue.newBuilder()
            .setKey("attribute_1")
    ...
    createExperimentRequest = getCreateExperimentRequest(project.getId(), "Experiment_4");
    attribute1 =
        KeyValue.newBuilder()
            .setKey("attribute_1")

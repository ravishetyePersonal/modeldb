...
public class VersioningTest {
  ...
  private static final Logger LOGGER = LogManager.getLogger(VersioningTest.class);
  /**
  ...
  public void repositoryTest() {
    ...
    VersioningServiceBlockingStub datasetServiceStub =
    ...
    SetRepository setRepository =
        SetRepository.newBuilder()
            ...
            .build();
    Response result = datasetServiceStub.createRepository(setRepository);
    ...
    GetRepositoryRequest.Response getByIdResult =
        datasetServiceStub.getRepository(getRepositoryRequest);
        ...
        SetRepository.newBuilder()
            .setId(
                RepositoryIdentification.newBuilder()
                    .setNamedId(RepositoryNamedIdentification.newBuilder().setName("name").build())
                    .build())
            .setRepository(Repository.newBuilder().setName("name2"))
            .build();
    result = datasetServiceStub.updateRepository(setRepository);
    ...
    getRepositoryRequest =
        GetRepositoryRequest.newBuilder()
            .setId(
                RepositoryIdentification.newBuilder()
                    .setNamedId(RepositoryNamedIdentification.newBuilder().setName("name2")))
            .build();
    GetRepositoryRequest.Response getByNameResult =
        datasetServiceStub.getRepository(getRepositoryRequest);
    ...
    DeleteRepositoryRequest.Response deleteResult =
        datasetServiceStub.deleteRepository(deleteRepository);
